...
//        public async Task<IEnumerable<BgValue>> GlucoseValues(DateTimeOffset start, DateTimeOffset end)
//        {
//            var nsql = await NightSql.GetInstance(Configuration);
//            var list = await nsql.ReadBg(start, end);
//            await nsql.DisposeAsync();
//            return list;
//        }
